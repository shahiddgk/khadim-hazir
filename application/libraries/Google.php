...
class Google {
	...
	public function __construct(){
		...
		$this->client->setClientId('413450778066-lf5sadcgu01mfbg88gphkpt3qmi86iht.apps.googleusercontent.com');
		$this->client->setClientSecret('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');
		$this->client->setRedirectUri('http://localhost/khadim-hazir/user/google_login');

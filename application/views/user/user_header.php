...
if($this->session->userdata('user_logged_in')){
    // if($this->session->userdata('usertype')!='employee' || $this->session->userdata('usertype')!='employer'){
    //     echo "nested if"; exit;
    //    redirect(site_url()); 
    // }
}
...
<head>
    ...
    <link rel="apple-touch-icon" href="<?php echo base_url()?>assets/images/azoozywhite.png">
    <link rel="shortcut icon" href="<?php echo base_url()?>assets/images/azoozywhite.png">
...
<aside id="left-panel" class="left-panel">
    <nav class="navbar navbar-expand-sm navbar-default">
        ...
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="<?=site_url('welcome/user_dashboard')?>"><?= $this->session->userdata('username')?></a>
        ...
        <div id="main-menu" class="main-menu collapse navbar-collapse">
            <ul class="nav navbar-nav">
                <li class="active">
                    <a href="<?=site_url('welcome/user_dashboard')?>"> <i class="menu-icon fa fa-dashboard"></i>Dashboard </a>   
                </li>
                ...
                <div class="header-left">
                    ...
                    <div class="dropdown for-message">
                        ...
                        <div class="dropdown-menu" aria-labelledby="message">
                            ...
                            <a class="dropdown-item media bg-flat-color-1" href="#">
                            <span class="photo media-left"><img alt="avatar" src="<?=base_url();?>images/avatar/1.jpg"></span>
                            ...
                            <a class="dropdown-item media bg-flat-color-4" href="#">
                            <span class="photo media-left"><img alt="avatar" src="<?=base_url();?>images/avatar/2.jpg"></span>
                            <span class="message media-body">
                            ...
                            <a class="dropdown-item media bg-flat-color-5" href="#">
                            <span class="photo media-left"><img alt="avatar" src="<?=base_url();?>images/avatar/3.jpg"></span>
                            <span class="message media-body">
                            ...
                            <span class="photo media-left"><img alt="avatar" src="<?=base_url();?>images/avatar/4.jpg"></span>
                            <span class="message media-body">
            ...
            <div class="col-sm-5">
                <div class="user-area dropdown float-right">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <img class="user-avatar rounded-circle" src="<?php echo base_url(); ?>images/<?php echo $images?>" alt="User Avatar">
                    </a>

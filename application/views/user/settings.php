                ...
                <section class="card">
                        ...
                        <div class="media">
                            <a href="#">
                                <img class="align-self-center rounded-circle mr-3" style="width:85px; height:85px;"
                                    alt="" src="<?php echo base_url(); ?>images/<?php echo $images ?>">
                            </a>
                    ...
                    <ul class="list-group list-group-flush">
                        <li class="list-group-item">
                            <a href="#"> <i class="fa fa-user "></i> Name: &nbsp;&nbsp;
                                <?= $name; ?>
                            </a>
                        </li>
                        <li class="list-group-item">
                            <a href="#"> <i class="fa fa-phone"></i> Phone: &nbsp;&nbsp;
                                <?= $phone_no; ?>
                            </a>
                        </li>
                        <li class="list-group-item">
                            <a href="#"> <i class="fa fa-envelope-o"></i> Email: &nbsp;&nbsp;
                                <?= $email; ?>
                            </a>
                        </li>
                    </ul>
                ...
                <form action="<?= site_url('welcome/update') ?>" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <div class="input-group">
                            ...
                            <input type="file" accept="image/*" id="profile-pic" name="images"

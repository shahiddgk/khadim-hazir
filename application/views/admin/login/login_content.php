                    ...
                    <form action="<?=site_url('admin/welcome/login_action')?>" method='post'>
                        <div class="form-group">
                            ...
                            <input <?php  if($this->input->cookie('user')!='') { ?>
                                value="<?php echo $this->input->cookie('user')?>"
                                <?php }  elseif($this->input->post('admin_email')!='') { ?>
                                value="<?php echo $this->input->post('admin_email')?>" <?php }  ?> type="text"
                                name="username" class="form-control" placeholder="enter email" required>
                        </div>
                        <div class="form-group">
                            <label>Password</label>
                            <input type="password" <?php if($this->input->cookie('pass')!='') { ?>
                                value="<?php echo $this->input->cookie('pass')?>" <?php } ?> name="password"

            ...
            <div class="card">
                <strong class="card-header">Add Category</strong>
                    <div class="card-body card-block">
                        <form action="<?=site_url('admin/category/insert_category')?>" method="post" enctype="multipart/form-data">
                    ...
                    <table class="table table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><img src="<?=base_url();?>uploads/category/<?=$data['eng']['image'];?>" class="img-responsive" alt="category" height="auto" width="50"></td>
                                <?php } else{ ?>
                                <td></td>
                                <?php } ?>
                                <td><a href="<?=site_url("admin/category/edit_category/").$data['eng']['category_id']?>"><button type="button" class="btn btn-outline-primary btn-sm">Edit</button></a> <a href="<?=site_url("admin/category/delete_category/").$data['eng']['category_id']?>"> <button type="button" class="btn btn-outline-danger btn-sm">Delete</button></a></td>             
                            </tr>
                            <?php $srn++; } } ?>
                        </tbody>
                    </table>
